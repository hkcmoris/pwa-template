...
try {
    $repository->clone($componentId);
    $viewModel = $presenter->presentInitial([
        'message' => 'Komponenta byla úspěšně zduplikována.',
    ...
    log_message('Component clone failed: ' . $e->getMessage(), 'ERROR');
    http_response_code(500);
    $viewModel = $presenter->presentInitial([
        'message' => 'Klonování komponenty se nepodařilo.',
        'message_type' => 'error',
    ]);
    components_render_fragments($viewModel);
}
